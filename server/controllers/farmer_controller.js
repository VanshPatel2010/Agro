        ...
        if (olduser) {
            ...
            farm.find({
                ...
                if(err)
                {
                    ...
                    data.save().then(() => {
                        // Twilio logic to send SMS has been removed from here.
                        return res.json({
                            status : "ok",
...
module.exports.mobilenumverify = function (req, res) {
    if (req.params.Mobilenum) {
        ...
        // Twilio client logic removed. Simply return the OTP.
        return res.json({
            OTP: otp,
            status: "ok"
        });
...
//Adhar card verification and return the mobile
...
module.exports.temp = function (req, res) {
    // Body of this function has been removed as it was only for Twilio.
    return res.json({
        status: "ok",
        result: "This function is disabled."
    });
}
